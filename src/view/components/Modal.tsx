  ...
  return (
    <RdxDialog.Root open={open} onOpenChange={onClose}>
      <RdxDialog.Portal>
        ...
        >
          <RdxDialog.Content className="absolute left-1/2 top-1/2 w-[90%] max-w-[400px] -translate-x-1/2 -translate-y-1/2 transform space-y-12 overflow-y-auto rounded-md bg-darkBlue-600 p-6 shadow-[0px_11px_20px_0px_rgba(0,0,0,0.10)] lg:w-full">
